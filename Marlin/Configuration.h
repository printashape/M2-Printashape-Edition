...
#define STRING_VERSION_CONFIG_H __DATE__ " M2Marlin24r2_2 / " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Michael Haas" // Who made the changes.
...
// Makergear
    ...
    #define  DEFAULT_Kd 93.99
	//values for M2 with 24V PSU, 24V/40W nozzle heater

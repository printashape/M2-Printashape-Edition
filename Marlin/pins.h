...
#define Y_DIGIPOT_CH 5
#define Z_DIGIPOT_CH 3
#define E0_DIGIPOT_CH 0
#define E1_DIGIPOT_CH 1
...
#define S#ifdef ULTRA_LCD
 ...
 //arduino pin which triggers an piezzo beeper
   ...
   // left up center down right red
    ...
    #define BLEN_A 0
  #endif 
#endif //ULTRA_LCDUICIDE_PIN        -1  //PIN that has to be turned on right after start, to keep power flowing.
